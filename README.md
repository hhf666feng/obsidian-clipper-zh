...
当前发布版：[v1.6.2-zh.28](https://github.com/hhf666feng/obsidian-clipper-zh/releases/tag/v1.6.2-zh.28)
...
1. 下载 `obsidian-web-clipper-1.6.2-zh.28-chrome.zip` 并解压。
...
1. 下载 `obsidian-web-clipper-1.6.2-zh.28-firefox.zip` 并解压。
