...
当前发布版：[v1.6.2-zh.21](https://github.com/hhf666feng/obsidian-clipper-zh/releases/tag/v1.6.2-zh.21)
...
1. 下载 `obsidian-web-clipper-1.6.2-zh.21-chrome.zip` 并解压。
...
1. 下载 `obsidian-web-clipper-1.6.2-zh.21-firefox.zip` 并解压。
...
升级到 `v1.6.2-zh.21` 后会补齐默认路由。也可以在设置页的“文件夹路由”中确认有这些规则：
